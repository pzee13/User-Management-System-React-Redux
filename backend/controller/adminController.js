...
const updateUserProfile = asyncHandler(async(req, res) => {
    ...
    if(user) {
        ...
        if(image){
            ...
            const oldImgPath = user.profile_image ? path.join( 'public', user.profile_image): null;
            if(oldImgPath){
...
export {login, getUserData, addUser, updateUserProfile,deleteUserData,logoutAdmin};