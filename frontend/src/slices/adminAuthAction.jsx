...
const deleteUserData = createAsyncThunk("/admin/deleteUser", async(userId) => {
...
export {loginAdminAsync, getUserData, addUser, updateUserData,deleteUserData,logoutAdmin};