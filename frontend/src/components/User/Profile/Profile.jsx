...
const Profile = () => {
    ...
    console.log('ggggggggggggggggggggggggggggggggggggggggggggggg',userInfo)
    ...
    ref={fileInpDivRef}
    style={{ 
        backgroundImage: userInfo?.profile_image 
            ? `url(http://localhost:3000/public/${userInfo.profile_image})` 
            : 'none' 
    }}
>
    {/* Add console log to check if userInfo.profile_image is populated */}
