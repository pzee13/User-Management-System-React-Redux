...
const Options = ({ userData,onDeleteUser }) => {
    ...
    const handleDelete = async () => {
        ...
        if (confirmDelete) {
            const response = await onDeleteUser(userData._id);
            if (response) {
            ...
            >
                ...
                <div className="admin-add-user flex justify-center items-center">
                    ...
                    <div className="change-img flex-1 flex justify-center">
                        ...
                        style={{backgroundImage: userData.profile_image? `url(http://localhost:3000/public/${userData.profile_image})`:"url(/src/assets/profile_10302971.png)"}}
                            ref={fileInpDivRef}
                        >
                            <input 
                                type="file" 
